...
CREATE TABLE freezing_drops(collection integer NOT NULL, in_registry smallint NOT NULL, in_index integer NOT NULL, start timestamp not null);

CREATE TABLE freezers(id integer NOT NULL PRIMARY KEY, name varchar(250) NOT NULL, description text);

CREATE TABLE compositions(collection integer NOT NULL, drop_index numeric(1000) NOT NULL, quality numeric(15, 10) NOT NULL, freezer integer NOT NULL, parameters jsonb);
...
CREATE TABLE autotests_control_values(id smallint NOT NULL, step integer NOT NULL, control_value jsonb);
